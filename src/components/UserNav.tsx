        ...
        <DropdownMenuTrigger asChild>
          <button className="flex items-center gap-2 p-1 pl-1 pr-2 rounded-full hover:bg-slate-100 transition-all border border-transparent hover:border-slate-100">
            <Avatar className="h-8 w-8 border border-white shadow-sm ring-1 ring-slate-100">
              ...
              <AvatarFallback className="bg-slate-900 text-white font-bold text-[10px]">AD</AvatarFallback>
            </Avatar>
            <ChevronDown size={14} className="text-slate-400" />
          </button>
        </DropdownMenuTrigger>
        <DropdownMenuContent className="w-64 bg-white border-slate-100 text-slate-600 shadow-2xl rounded-2xl mt-2 p-2" align="end">
          <DropdownMenuLabel className="font-normal p-4 pb-3">
            <div className="flex flex-col space-y-1">
              <p className="text-[13px] font-bold leading-none text-slate-900 uppercase tracking-tight">Administrator</p>
