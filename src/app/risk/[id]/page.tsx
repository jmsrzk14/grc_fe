    ...
    <div className="space-y-6 animate-in fade-in duration-500 w-full px-2 pb-10">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <HeaderTitle title={`Detail Risiko: ${id}`} />
        </div>
        ...
        <div className="space-y-6 w-full">
          <Card className="border border-border shadow-sm bg-card rounded-xl overflow-hidden">
            <CardHeader className="bg-muted/20 border-b border-border px-6 py-4">
              <CardTitle className="text-xs font-bold uppercase tracking-[0.2em] text-muted-foreground">Profil Definitif Risiko</CardTitle>
            </CardHeader>
            <CardContent className="p-6 space-y-6">
               <div className="grid grid-cols-2 gap-6">
                 ...
                 <div className="bg-slate-50/50 p-4 rounded-lg border border-slate-100">
                   <p className="text-[10px] uppercase font-bold text-slate-400 tracking-widest mb-1">Severity / Tingkat Bahaya</p>
                   <p className="text-sm font-bold text-rose-600">Critical (12.0)</p>
                 </div>
                 <div className="col-span-2 bg-slate-50/50 p-4 rounded-lg border border-slate-100">
                   <p className="text-[10px] uppercase font-bold text-slate-400 tracking-widest mb-1.5">Deskripsi Kasus Utama</p>
                   <p className="text-sm text-slate-600 leading-relaxed font-medium">Ini adalah halaman tinjauan detail untuk identifikasi risiko {id}. Secara default di versi integrasi, komponen ini akan merender kronologi penyebab risiko dan rekomendasi mitigasi AI.</p>
                 </div>
               </div>
            </CardContent>
          </Card>
