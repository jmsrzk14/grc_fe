...
export default function CompliancePage() {
  ...
  return (
    <div className="space-y-6 pb-12 animate-in fade-in duration-500 w-full px-2">
            ...
            {loading ? (
              ...
              filteredRegulations.map((reg: any) => (
                <Link key={reg.id} href={`/compliance/${reg.id}`}>
                  <Card className="group relative overflow-hidden border border-slate-100 shadow-sm bg-white rounded-2xl hover:shadow-md hover:border-blue-200 transition-all duration-300 cursor-pointer">
